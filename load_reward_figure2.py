...
# load the original
with open('ac_activelearning_mountaincar_good2.pickle', 'rb') as fp:
    [a1, b1, lens1, rewards1] = pickle.load(fp)

with open('ac_activelearning_mountaincar.pickle', 'rb') as fp:
    [a1, b1, lens2, rewards2] = pickle.load(fp)
